 ...
 * @author jacquet
 */
public class BuscarAgendamento extends javax.swing.JFrame {

    /**
     * Creates new form BuscarAgendamento
     */
    ...
    private void OnClickBuscar_Agendamento() throws SQLException{
        String CPF = jFormattedTextField2.getText();
        AgendamentoController agenda = new AgendamentoController();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarAgendamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarAgendamento().setVisible(true);
            }
        });
    }
